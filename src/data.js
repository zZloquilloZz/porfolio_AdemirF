  ...
  es: {
    ...
    skills: {
      ...
      categories: [
        {
          name: "Lenguajes",
          items: ["Python", "JavaScript", "TypeScript", "SQL", "Bash", "AWK"],
        },
        {
          name: "Frontend",
        ...
        {
          name: "Testing",
          items: ["Vitest", "Playwright", "pytest"],
        },
        {
          name: "Herramientas",
          items: ["Azure DevOps", "JIRA", "Trello", "Postman", "DBeaver"],
        },
      ],
    },
    experience: {
      ...
      jobs: [
        {
          ...
          bullets: [
            ...
            "Implementé consultas SQL avanzadas con CTEs y JSONB en PostgreSQL para analizar millones de registros (Notifications, WorkItems, OrderEvents), identificando registros obsoletos con 99.8% de precisión para sustentar decisiones de purgado en producción.",
            "Desarrollé módulos de diagnóstico que traducen errores técnicos (exit codes, OOM, HikariPool, variables TMF622) a lenguaje operativo, con reportes 'foto-friendly' y exportación a Excel/HTML; sostuve la calidad con ~527 pruebas automatizadas (pytest).",
            "Diseñé y mantuve dashboards en Power BI y Grafana y análisis de logs en Datadog para KPIs y observabilidad operativa, con detección proactiva de incidencias por severidad y frecuencia.",
          ],
        },
        {
      ...
      jobs: [
        {
          ...
          bullets: [
            ...
            "Developed diagnostic modules that translate technical errors (exit codes, OOM, HikariPool, TMF622 variables) into operational language, with photo-friendly reports and Excel/HTML export; kept quality up with ~527 automated tests (pytest).",
